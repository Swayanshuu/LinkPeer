...
void main() async {
  final Map<String, String> fileMap = {
    ...
    'Component/CreatePost/CreatePostInputCard.dart': 'screens/post/components/create_post_input_card.dart',
    'Component/CreatePost/CreatePostLivePreview.dart': 'screens/post/components/create_post_live_preview.dart',
    'Component/CreatePost/CreatePostTopSection.dart': 'screens/post/components/create_post_top_section.dart',
    'Component/CreatePost/TextfielsBuild.dart': 'screens/post/components/text_fields_build.dart',
    
    'Component/Home/FeedFilterBar.dart': 'screens/home/components/feed_filter_bar.dart',
    'Component/Home/HomeHeader.dart': 'screens/home/components/home_header.dart',
    ...
    'Component/Onboarding/OnboardingTemplate.dart': 'screens/onboarding/components/onboarding_template.dart',
    'Component/Onboarding/OnboardingUserDetailsScreen.dart': 'screens/onboarding/components/onboarding_user_details_screen.dart',
    
    'Component/Profile/ProfileGridPainter.dart': 'screens/profile/components/profile_grid_painter.dart',
    'Component/Profile/ProfileHeaderSliver.dart': 'screens/profile/components/profile_header_sliver.dart',
    'Component/Profile/ProfilePostSection.dart': 'screens/profile/components/profile_post_section.dart',
    'Component/Profile/ProfileStatsBox.dart': 'screens/profile/components/profile_stats_box.dart',
    'Component/Profile/ProfileStatsRow.dart': 'screens/profile/components/profile_stats_row.dart',
    ...
    'Screens/FacultyVerificationScreen.dart': 'screens/auth/faculty_verification_screen.dart',
    'Screens/HomeScreen.dart': 'screens/home/home_screen.dart',
    'Screens/LogInScreen2.dart': 'screens/auth/login_screen.dart',
    'Screens/OnBoardingScreen.dart': 'screens/onboarding/onboarding_screen.dart',
    'Screens/PrivacyPolicySheet.dart': 'screens/about/privacy_policy_sheet.dart',
    'Screens/SearchScreen.dart': 'screens/search/search_screen.dart',
    
    'Screens/Post/CreatePostScreen.dart': 'screens/post/create_post_screen.dart',
    ...
    'Screens/Profile/EditProfileScreen.dart': 'screens/profile/edit_profile_screen.dart',
    'Screens/Profile/ProfileScreen.dart': 'screens/profile/profile_screen.dart',
    'Screens/Profile/SettingsScreen.dart': 'screens/profile/settings_screen.dart',
  ...
  print('Step 1: Converting all relative imports to absolute package imports...');
  for (final file in dartFiles) {
    String content = file.readAsStringSync();
    
    content = content.replaceAllMapped(RegExp(r'''import\s+['"]([^'"]+)['"]\s*;'''), (match) {
      ...
      final packagePath = p.relative(resolvedPath, from: libDir.path).replaceAll('\\', '/');
  ...
  print('Step 2: Updating absolute package imports to point to their new snake_case locations...');
  for (final file in dartFiles) {
    String content = file.readAsStringSync();
    
    for (final oldPath in fileMap.keys) {
      final newPath = fileMap[oldPath]!;
      final oldPackagePath = 'package:igit_connects/${oldPath.replaceAll('\\', '/')}';
      final newPackagePath = 'package:igit_connects/${newPath.replaceAll('\\', '/')}';
